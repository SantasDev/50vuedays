...
<script setup lang="ts">
  import type { MenuItem } from '@/components/rotating_navigation/RotatingNavigation.types';
  import RotatingNavigation from '@/components/rotating_navigation/RotatingNavigation.vue';
